...
Auto-updated tracking of AMD GPU ecosystem projects. Last updated: **2026-03-06 08:13 UTC**

## Overview

| Project | Role | Latest Release | Open PRs | Open Issues | Links |
|---------|------|----------------|----------|-------------|-------|
| **pytorch** | watch | v2.10.0 | 54 | 52 | [repo](https://github.com/pytorch/pytorch) |
| **jax** | watch | jax-v0.9.1 | 17 | 33 | [repo](https://github.com/jax-ml/jax) |
| **vllm** | watch | v0.16.0 | 71 | 50 | [repo](https://github.com/vllm-project/vllm) / [fork](https://github.com/sunway513/vllm) |
| **sglang** | watch | v0.5.9 | 60 | 43 | [repo](https://github.com/sgl-project/sglang) |
| **xla** | watch | - | 33 | 9 | [repo](https://github.com/openxla/xla) |
...
| **aiter** | dev | v0.1.9 | 157 | 106 | [repo](https://github.com/ROCm/aiter) / [fork](https://github.com/sunway513/aiter) |
| **atom** | dev | - | 37 | 13 | [repo](https://github.com/ROCm/ATOM) / [fork](https://github.com/sunway513/ATOM) |
| **mori** | dev | - | 9 | 10 | [repo](https://github.com/ROCm/mori) / [fork](https://github.com/sunway513/mori) |
| **flydsl** | dev | exp_i8smooth_v0.1 | 4 | 10 | [repo](https://github.com/ROCm/FlyDSL) / [fork](https://github.com/sunway513/FlyDSL) |
| **transformer_engine** | dev | v2.4_rocm | 21 | 7 | [repo](https://github.com/ROCm/TransformerEngine) |
